...
export default defineConfig({
  lang: 'zh-CN',
  title: 'Nostalgia',
  description: 'Nostalgia 的笔记 - 前端个人开放文档',
  srcDir: 'src',
  outDir: './dist',
  lastUpdated: true,
    ...
    socialLinks: [
      {
        ...
        link: 'https://clock.Nostalgia.top/time'
      },
      { icon: 'github', link: 'https://github.com/LiuJianlove/notes' }
    ],

    editLink: {
      pattern: 'https://github.com/Nostalgia/notes/edit/master/src/:path',
      text: '在 GitHub 上编辑此页'
    },

    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright © 2023-PRESENT Nostalgia'
    }
  },
